...
export function 输入栏({
  ...
  return (
    <div className="bg-transparent w-full px-4 sm:px-8 lg:px-12 pb-8 pt-6">
      ...
      <div className="bg-white/95 rounded-[32px] shadow-[0_28px_75px_rgba(15,23,42,0.08)] border border-white/80 p-4 sm:p-6">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            <Button
              type="button"
              variant="ghost"
              className="rounded-2xl bg-slate-100 text-slate-600 hover:bg-slate-200 px-4"
              disabled={disabled}
            ...
            <div className="flex-1 relative">
              <Textarea
                ...
                className="min-h-[56px] max-h-40 resize-none bg-transparent border-0 focus-visible:ring-0 focus-visible:ring-offset-0 pr-28 text-base leading-relaxed placeholder:text-slate-400"
                disabled={disabled}
              />
              <div className="absolute right-0 bottom-1 flex items-center gap-1">
                <Button
                  variant="ghost"
                  size="icon"
                  className="w-10 h-10 rounded-full text-slate-500 hover:bg-slate-100"
            ...
            <div className="flex items-center">
              {isStreaming ? (
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="w-12 h-12 rounded-full bg-slate-900 text-white hover:bg-slate-800"
                >
